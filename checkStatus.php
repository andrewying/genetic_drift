...
<body>
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        <p>The current status of the job is shown below. The page would automatically update every 5 seconds. You may add this page to your bookmark and come back to retrive the result of the simulation within the following 24 hours.</p>
      </div>
    </div>
    <div class="row">
      <div class="col-md-3">
